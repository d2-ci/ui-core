...
function (_PureComponent) {
  ...
  function AlertBar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startHideTimeout", function () {
      _this.timeout = setTimeout(function () {
        _this.hide();
      }, _this.timeRemaining);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "stopHideTimeOut", function () {
