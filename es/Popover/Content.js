...
export const Content = React.forwardRef(({
  ...
  ref: ref,
  style: position,
  className: _JSXStyle.dynamic([["2029485037", [colors.white, colors.white, colors.white,
  /**
