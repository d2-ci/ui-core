...
class ScrollBar extends PureComponent {
  ...
  render() {
    ...
    return React.createElement("div", {
      className: "jsx-4061674243 " + _JSXStyle.dynamic([["1687634598", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-bar"
    }, React.createElement("button", {
      onClick: scrolledToStart ? undefined : this.scrollLeft,
      className: "jsx-4061674243 " + _JSXStyle.dynamic([["1687634598", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + (cx('scroll-button', {
        disabled: scrolledToStart
      }) || "")
    }, _ref), React.createElement("div", {
      className: "jsx-4061674243 " + _JSXStyle.dynamic([["1687634598", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-box-clipper"
    }, React.createElement("div", {
      ref: this.scrollBox,
      className: "jsx-4061674243 " + _JSXStyle.dynamic([["1687634598", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-box"
    }, React.createElement("div", {
      ref: this.scrollArea,
      className: "jsx-4061674243 " + _JSXStyle.dynamic([["1687634598", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-area"
