...
const Tab = forwardRef(({
  ...
  ref: ref,
  className: _JSXStyle.dynamic([["3666495809", [fixed ? 1 : 0]], ["3504351397", [colors.grey400, colors.grey700, colors.grey700, colors.grey100, colors.grey200, colors.grey900, colors.grey900, colors.grey500, colors.grey500]]]) + " " + `${cx({
    selected,
    disabled,
    fixed
  })}`
