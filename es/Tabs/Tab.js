...
const Tab = ({
  ...
  className: _JSXStyle.dynamic([["1376158693", [colors.grey400, colors.grey600, colors.grey600, colors.grey100, colors.grey200, theme.primary700, theme.primary700, theme.primary700, colors.grey500, colors.grey500]]]) + " " + `${cx('tab', {
    selected,
    disabled
  })}`
