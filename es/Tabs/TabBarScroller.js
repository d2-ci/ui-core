...
const TabBarScroller = ({
  ...
  className: _JSXStyle.dynamic([["660344677", [marginBottom]], ["3687618214", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + (cx('scroll-button', {
    disabled: scrolledToStart
  }) || "")
}, _ref), React.createElement("div", {
  className: _JSXStyle.dynamic([["660344677", [marginBottom]], ["3687618214", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-box-clipper"
}, React.createElement("div", {
  ref: scrollBoxRef,
  className: _JSXStyle.dynamic([["660344677", [marginBottom]], ["3687618214", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-box"
}, React.createElement("div", {
  ref: scrollAreaRef,
  className: _JSXStyle.dynamic([["660344677", [marginBottom]], ["3687618214", [colors.white, colors.grey400, colors.grey600, colors.grey100, colors.grey200, colors.grey500]]]) + " " + "scroll-area"
